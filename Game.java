...
public class Game {
  ...
  private void createRooms() {
    ...
    basket = new Room("in the basketball room");
    hall = new Room("in the conference hall");

    // initialise room exits
    outside.setExit("east", theater);
    outside.setExit("south", lab);
    outside.setExit("west", pub);
    outside.setExit("north", basket);

    theater.setExit("west", outside);

    pub.setExit("east", outside);
    pub.setExit("south", hall);
    ...
    basket.setExit("south", outside);

    hall.setExit("north", pub);
    ...
    switch (commandWord) {
      ...
      case "back":
        if (lastRoom != null) {
          ...
          System.out.println("You are already outside the main entrance of the university.");
        }
        break;
      default:
        break;
